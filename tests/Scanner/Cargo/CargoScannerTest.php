...
class CargoScannerTest extends TestCase
{
    private CargoLockParser&MockObject $parser;
    private CargoScanner $scanner;

    protected function setUp(): void
    {
        $this->parser = $this->createMock(CargoLockParser::class);
        $this->scanner = new CargoScanner($this->parser);
    }
